...
export const ImsdSourceTallyBook: React.FC = () => {
  ...
  const selectedTransactions = useMemo(() => {
    ...
    return tallyTransactions
      .filter(transaction => ledgerKey(transaction) === ledgerKey(selectedItem))
